        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 text-right">
                    <br>
                    <?php echo $this->Html->link('<i class="fa fa-search"></i> Procurar Vagas', array('controller' => 'users', 'action' => 'vagas'), array('class' => 'btn btn-success btn-sm', 'title' => 'Mais Vagas', 'escape' => false)); ?>
                </div>
            </div>
                ...
                ?>
                    <div class="col-xs-12">
                        <div class="item-block<?php echo $vaga['Vaga']['ativo'] == 0 ? ' item-removed': '' ;?>">
                            <header>
                                <a href="<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'vaga', 'id' => $vaga['Vaga']['id'])); ?>">
                                    <?php
                                ...
                                <div class="hgroup">
                                    <h4><a href="<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'vaga', 'id' => $vaga['Vaga']['id'])); ?>"><?php echo $vaga['Vaga']['nome']; ?></a></h4>
                                    <h5><a href="<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'vaga', 'id' => $vaga['Vaga']['id'])); ?>"><?php echo $vaga['Empresa']['nome']; ?></a></h5> </div>
                            ...
                            <footer>
                                ...
                                <div class="action-btn"> 
                                    <?php echo $this->Html->link('Visualizar Vaga', array('controller' => 'users', 'action' => 'vaga', 'id' => $vaga['Vaga']['id']), array('class' => 'btn btn-xs btn-info', 'title' => 'Editar vaga '. $vaga['Vaga']['nome'])) ?>
                                    &nbsp;
                                    <?php
                                        if($vaga['Vaga']['ativo'] == 1 && $vaga['Vaga']['status'] != 3){
                                            echo $this->Html->link('Cancelar candidatura', array('controller' => 'empresas', 'action' => 'excluirVaga', 'id' => $vaga['Vaga']['id']), array('class' => 'btn btn-xs btn-danger', 'title' => 'Excluir vaga '. $vaga['Vaga']['nome']));
                                        }
                                    ?>
                                </div>
                            </footer>
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                  <ul class="pagination">
                    <?php
                        $this->Paginator->options['url'] = array('controller' => 'trabalhador_vaga', 'action' => 'historicoCandidaturas');
