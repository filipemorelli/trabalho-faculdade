    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-4">
                <?php echo $this->Html->image('/template/img/avatar.jpg', array('alt'   => '',
                                                                                'title' => ''
                )); ?>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="item-block">
                        <header>
                            <?php echo $this->Html->image('/template/img/logo-mit.png', array('alt'   => '',
                                                                                              'title' => ''
                            )); ?>
                            <div class="hgroup">
                                <h4>Master
                ...
                <div class="col-xs-12">
                    <div class="item-block">
                        <header>
                            <?php echo $this->Html->image('/template/img/logo-berkeley.png', array('alt'   => '',
                                                                                                   'title' => ''
                            )); ?>
                            <div class="hgroup">
                                <h4>Bachelor
                        ...
                        <div class="item-body">
                            <p>The University of California, Berkeley is a public research university located in
                                Berkeley, California. It is the flagship campus of the University of California system,
                                one of three parts in the state's public higher education plan, which also includes the
                    ...
                    <div class="item-block">
                        ...
                        <div class="item-body">
                            ...
                            <ul>
                                ...
                                <li>Responsible for all aspects of presentation layer development including developing
                                    templates using HTML, DHTML, Javascript, XML, and XSL.
                                </li>
                    ...
                    <div class="item-block">
                        ...
                        <div class="item-body">
                            ...
                            <ul>
                                ...
                                <li>Software Test Plans from Business Requirement Specifications for test engineering
                                    group.
                                </li>
                                <li>Run production tests as part of software implementation; Create, deliver and support
                                    test plans for testing group to execute.
                                </li>
