        ...
        <div class="header-detail descricao-vaga">
            ...
            <ul class="details cols-3">
                <li><i class="fa fa-map-marker"></i>
                    <span><?php echo $vaga['Endereco']['bairro'] . ', ' . $vaga['Endereco']['cidade'] . ', ' . $vaga['Endereco']['estado']; ?></span>
                </li>
                <li><i class="fa fa-briefcase"></i>
                    <span><?php echo ucfirst($vaga['Vaga']['periodo_trabalho']); ?></span></li>
                <li><i class="fa fa-money"></i>
                    <span>R$ <?php echo str_replace(".", ",", $vaga['Vaga']['salario']); ?></span></li>
                <li><i class="fa fa-clock-o"></i> <span><?php echo $vaga['Vaga']['horario_trabalho']; ?>/h</span></li>
                <li><i class="fa fa-graduation-cap"></i>Escolaridade:
                    <span><?php echo $this->Escolaridade->escolaridadeTexto($vaga['Vaga']['escolaridade']) ?></span>
                </li>
            ...
            <div class="button-group">
                <ul class="social-icons">
                    ...
                    <li><a class="google-plus" target="_blank"
                           href="https://plus.google.com/share?url=<?php echo Router::url($this->here, true); ?> "><i
                ...
                <div class="action-buttons">
                    ...
                    if ($this->Session->read('Auth.User.tipo') !== "trabalhador") {
                        ...
                        echo $this->Html->link('Candidatar', array(
                            ...
                            'id'         => $vaga['Vaga']['id']
                        ), array('class' => 'btn btn-info btn-candidatar'));
                    }
                    ?>
                </div>
            </div>
