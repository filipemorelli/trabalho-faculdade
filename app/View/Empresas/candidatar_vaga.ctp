<header class="page-header bg-img size-lg"
    ...
    <div class="container no-shadow">
        ...
        <p class="lead text-center">Apply with your online resume, create new resume for the job, or make a custom
            application.</p>
        <hr>
        ...
        <div class="button-group">
            <div class="action-buttons"><a class="btn btn-gray" href="#sec-custom">Custom application</a> <a
                        class="btn btn-primary" href="#sec-resume">Apply with a resume</a></div>
        </div>
    </div>
</header>
<main>
        ...
        <div class="container">
            ...
            <div class="item-block">
                ...
                <footer>
                    ...
                    <div class="action-btn"><a class="btn btn-xs btn-gray" href="#">Edit</a> <a
                                class="btn btn-xs btn-success" href="#">Select</a></div>
                </footer>
            </div>
            <div class="item-block">
                <header>
            ...
            <br>
            <div class="row">
                <div class="col-xs-12 col-md-3"><a class="btn btn-block btn-primary" href="resume-add.htm">Add new
                        resume</a></div>
            </div>
        </div>
    </section>
