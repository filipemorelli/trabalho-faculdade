<header class="page-header bg-img size-lg" style="background-image: url(<?php echo $this->html->url('/template/img/bg-banner2.jpg');?>)">
    <div class="container">
        <div class="header-detail"> <img class="logo" src="<?php echo $this->html->url('/template/img/logo-google.jpg');?>" alt="">
            <div class="hgroup">
                <h1>Google</h1>
                <h3>Internet and computer software</h3> </div>
            <hr>
            ...
            <ul class="details cols-3">
                ...
                <li> <i class="fa fa-globe"></i> <a href="#">Google.com</a> </li>
                <li> <i class="fa fa-users"></i> <span>50,000 - 70,000 employer</span> </li>
                <li> <i class="fa fa-birthday-cake"></i> <span>From 1998</span> </li>
                <li> <i class="fa fa-phone"></i> <span>(+1) 123 456 7890</span> </li>
                <li> <i class="fa fa-envelope"></i> <a href="#">info@google.com</a> </li>
            </ul>
