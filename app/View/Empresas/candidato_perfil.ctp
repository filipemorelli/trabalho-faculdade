    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 header-detail">
                <div class="hgroup">
                    <h1><?= $trabalhador['Trabalhador']['nome'] ?></h1>
                    <h3><?= $trabalhador['Trabalhador']['profissao'] ?></h3>
                </div>
                <hr>
                <p class="lead"><?= $trabalhador['Trabalhador']['descricao_rapida'] ?></p>

                <ul class="details cols-2">
                    <li>
                        <i class="fa fa-map-marker"></i>
                        <span><?= $this->Utility->enderecoToLinkGoogleMaps($trabalhador['Endereco']) ?></span>
                    </li>
            ...
            <div class="row">
                    ...
                    <div class="item-block">
                        ...
                        <div class="item-body">
                            <p>The Massachusetts Institute of Technology (MIT) is a private research university in Cambridge,
                                Massachusetts. Founded in 1861 in response to the increasing industrialization of the United
                                States, MIT adopted a European polytechnic university model and stressed laboratory instruction
                ...
                <div class="col-xs-12">
                    <div class="item-block">
                        ...
                        <div class="item-body">
                            <p>The University of California, Berkeley is a public research university located in Berkeley, California.
                                It is the flagship campus of the University of California system, one of three parts in the
                                state's public higher education plan, which also includes the California State University
                                system and the California Community Colleges System.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12">
                    <div class="item-block">
                        ...
                        <div class="item-body">
                            ...
                            <ul>
                                <li>Developed front-end for world-class online social viewing video and chat platform using xHTML,
                                    CSS, ActionScript 2-3, Javascript, and XML.</li>
                                <li>Developed built-in chat application into Flash video player in ActionScript 3.</li>
                                <li>Built and developed sites for ABC Family properties such as Gilmore Girls, The Middleman,
                                    Secret Life of an American Teenager, Greek, and Kyle XY. </li>
                    ...
                    <div class="item-block">
                        ...
                        <div class="item-body">
                            ...
                            <ul>
                                ...
                                <li>Responsible for all aspects of presentation layer development including developing templates
                                    using HTML, DHTML, Javascript, XML, and XSL.</li>
                    ...
                    <div class="item-block">
                        ...
                        <div class="item-body">
                            ...
                            <ul>
                                ...
                                <li>Run production tests as part of software implementation; Create, deliver and support test
                                    plans for testing group to execute.</li>
