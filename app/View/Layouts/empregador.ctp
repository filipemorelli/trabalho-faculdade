...
<nav class="navbar">
    <div class="container">
        ...
        <ul class="nav-menu">
            ...
            <li>
                <?php echo $this->Html->link('<i class="ti-plus"></i> Add Vaga', array(
                    'controller' => 'empresas',
                    'action'     => 'adicionarVaga'
                ), array(
                    'title'  => 'Add Vaga',
                    'escape' => false
                )); ?>
            ...
            <li>
                <?php echo $this->Html->link('<i class="ti-layout-list-thumb"></i> Nossas Vagas', array(
                    'controller' => 'empresas',
                    'action'     => 'listarVagas'
                ), array(
                    'title'  => 'Listar Vagas da Empresa',
                    'escape' => false
                )); ?>
            </li>
            <li>
                ...
                <ul>
                    <li>
                        <?php echo $this->Html->link('Perfil Empresa', array(
                            'controller' => 'empresas',
                    ...
                    <li>
                        <?php echo $this->Html->link('Editar Pefil Empresa', array(
                            'controller' => 'empresas',
                            'action'     => 'editarPerfilEmpresa'
                        ), array(
                            'title'  => 'Pefil Empresa',
                            'escape' => false
                        )); ?>
