...
<header class="site-header size-lg text-center"
    ...
    <div class="container">
        <div class="col-xs-12">
            <br><br>
            <h2>Nós oferecemos
                <mark><?php echo $qtdeVagas; ?></mark>
                vagas de emprego agora!
            </h2>
            ...
            <div class="btn-search">
                ...
                <?php echo $this->Html->link('Pesquisa avançada', array(
                    'controller' => 'users',
                    'action'     => 'vagas'
                ), array('title' => 'Pesquisa avançada')); ?>
            </div>
            </form>
        </div>
...
<main>
    ...
    <section>
        <div class="container">
            ...
            <br><br>
            <p class="text-center">
                <?php echo $this->Html->link('Veja todas as vagas', array(
                    'controller' => 'users',
                    'action'     => 'vagas'
                ), array(
                    'title' => 'Veja todas as vagas',
                    'class' => 'btn btn-info'
                )); ?>
