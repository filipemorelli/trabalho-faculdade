    ...
    <header class="page-header bg-img size-lg" style="background-image: url(<?php echo $this->Html->url('/template/img/bg-banner2.jpg'); ?>">
      <div class="container no-shadow">
        ...
        <p class="lead text-center">Continue lendo esta página para descobrir como começamos e quem está por trás disso!</p>
      </div>
    </header>
    <!-- END Site header -->
        ...
        <div class="row equal-team-members">
          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="team-member">
              ...
              <?php echo $this->Html->image('/template/img/avatar-1.jpg', array('alt' => 'avatar', 'class' => 'avatar'))?>
          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="team-member">
              ...
              <?php echo $this->Html->image('/template/img/avatar-3.jpg', array('alt' => 'avatar', 'class' => 'avatar'))?>
              <ul class="social-icons">
                <li><a class="twitter" href="#"><i class="fa fa-twitter"></i></a></li>
                <li><a class="linkedin" href="#"><i class="fa fa-linkedin"></i></a></li>
                <li><a class="dribbble" href="#"><i class="fa fa-dribbble"></i></a></li>
          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="team-member">
              ...
              <?php echo $this->Html->image('/template/img/avatar-2.jpg', array('alt' => 'avatar', 'class' => 'avatar'))?>
              <ul class="social-icons">
                <li><a class="twitter" href="#"><i class="fa fa-twitter"></i></a></li>
                <li><a class="linkedin" href="#"><i class="fa fa-linkedin"></i></a></li>
                <li><a class="dribbble" href="#"><i class="fa fa-dribbble"></i></a></li>
