            ...
            <div class="col-xs-6 col-md-3">
                ...
                <ul class="footer-links">
                    <li><?php echo $this->Html->link('Sobre', array(
                            'controller' => 'pages',
                            'action'     => 'sobre'
                        ), array('title' => 'Sobre')); ?></li>
                    <li><?php echo $this->Html->link('Contato', array(
                            'controller' => 'pages',
                            'action'     => 'contato'
                        ), array('title' => 'Contato')); ?></li>
                    <li><?php echo $this->Html->link('Políticas de Privacidade', array(
                            'controller' => 'pages',
                            'action'     => 'politicasDePrivacidade'
                        ), array('title' => 'Políticas de Privacidade')); ?></li>
                    <li><?php echo $this->Html->link('Termos de Uso', array(
                            'controller' => 'pages',
                            'action'     => 'termosDeUso'
                        ), array('title' => 'Termos de Uso')); ?></li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-sm-6 col-xs-12">
                <p class="copyright-text">Copyrights &copy; 2016 All Rights Reserved by <a href="#freejobs">FreeJob</a>.
                </p>
            </div>
