 ...
 */
	Configure::write('Security.salt', 'SDna7Eq37DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '26867627287685930965742496749683645');
